...
#Gruvbox
def gruvbox():
	colors = [["#282828", "#282828"],  #bg (black) [0]
			   ["#3c3836", "#3c3836"],  #bg light [1]
			   ["#ebdbb2", "#ebddb2"],  #fg [2]
			   ["#a89984", "#a89984"],  #fg dark [3]
			   ["#458588", "#458588"],  #blue [4]
			   ["#83a598", "#83a598"],  #blue light [5]
			   ["#98971a", "#98971a"],  #green [6]
			   ["#b8bb26", "#b8bb26"],  #green light [7]
			   ["#d65d0e", "#d65d0e"],  #orange [8]
			   ["#fe8019", "#fe8019"],  #orange light [9]
               ["#b16286", "#b16286"],  #purple [10]
			   ["#d3869b", "#d3869b"],  #purple light [11]
			   ["#cc241d", "#cc241d"],  #red [12]
			   ["#fb4934", "#fb4934"],  #red light [13]
			   ["#d79921", "#d79921"],  #yellow [14]
			   ["#fabd2f", "#fabd2f"],  #yellow light[15]
			   ["#689d6a", "#689d6a"],  #aqua [16]
               ["#8ec07c", "#8ec07c"]]  #aqua light [17] 
